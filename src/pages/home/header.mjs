...
<header class="three">
   <div class="container">
      <div class="row align-items-center">
         <div class="col-xl-3">
            <div class="logo">
               <a href="/"><img alt="logo-white" src="/assets/img/logo-white-color.png"></a>
               <div class="bar-menu">
         ...
         <div class="col-xl-3">
            <div class="contact">
               ...
               <div>
                  ...
                  <a href="callto:+1(850)344066"><h6>+1 (850) 344 0 66</h6></a></div>
            </div>
         </div>
         <div class="col-xl-3">
